...
export DATA_DIR="/projects/HAT/Theory_of_mind/LLaVA-RLHF/RLHF/LLaVA-Human-Preference-10K"
export MODEL_DIR="/projects/HAT/Theory_of_mind/LLaVA-RLHF/RLHF"
...
POLICY_LORA=LLaVA-RL-INIT-13b-v1.5-336-lora-padding_drivelm/lora_default
RM_LORA=LLaVA-Fact-RM-13b-v1.5-336-lora-padding-drivelm/checkpoint-1380  # we use early stopping

# SAVE CONFIG
MODEL_NAME=LLaVA-RL-Fact-RLHF-13b-v1.5-336-lora-padding-drivelm
...
torchrun \
    ...
    --warmup_steps 5 \
    --dataset_path $DATA_DIR/front_cam.json \
    --train_splits "train" \
    ...
    --image_folder /projects/HAT/Theory_of_mind/drivelm-main/DriveLM/challenge/llama_adapter_v2_multimodal7b \
    --vision_tower $VISION_TOWER \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --freeze_mm_mlp_adapter True \
    --reward_prompt_file "./prompts/reward_prompt.txt" \
